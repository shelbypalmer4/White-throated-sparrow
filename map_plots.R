...
the_maps.projected_2015on <- the_maps.projected[which(the_maps.projected$Year > 2014),]
the_maps.projected_20102014 <- the_maps.projected[which(the_maps.projected$Year < 2015 & the_maps.projected$Year > 2009),]
the_maps.projected_20052009 <- the_maps.projected[which(the_maps.projected$Year < 2010 & the_maps.projected$Year > 2004),]
the_maps.projected_2004_and_earlier <- the_maps.projected[which(the_maps.projected$Year < 2005),]
...
palette(alpha(c("#37a8b7", "#FE9929", "#AE017E"), 0.6))
##Rhythm plots
png(filename = "pre-2005_poetry", width = 7, height = 7, units = "in", res = 300)
plot(mapExtentPr, pch=NA)
plot(can1Pr, border="black", col="white", add=TRUE)
plot(us1Pr, border="black", col="white", add=TRUE)
points(the_maps.projected_2004_and_earlier, pch = 16, cex = 2, col = the_maps.projected_2004_and_earlier$poetry)
dev.off()
...
plot(can1Pr, border="black", col="white", add=TRUE)
plot(us1Pr, border="black", col="white", add=TRUE)
points(the_maps.projected_20052009, pch = 16, cex = 2, col = the_maps.projected_20052009$poetry)
dev.off()
...
plot(can1Pr, border="black", col="white", add=TRUE)
plot(us1Pr, border="black", col="white", add=TRUE)
points(the_maps.projected_20102014, pch = 16, cex = 2, col = the_maps.projected_20102014$poetry)
dev.off()
...
plot(can1Pr, border="black", col="white", add=TRUE)
plot(us1Pr, border="black", col="white", add=TRUE)
points(the_maps.projected_2015on, pch = 16, cex = 2, col = the_maps.projected_2015on$poetry)
dev.off()
